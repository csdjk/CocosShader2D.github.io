...
System.register("chunks:///_virtual/EdgeDetectionPass.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "15ebbitGIxBybhAt8Hrb0Yz", "EdgeDetectionPass", undefined);
...
System.register("chunks:///_virtual/main", ['./debug-view-runtime-control.ts', './FirstPersonCamera.ts', './MaterialProperty.ts', './PostProcessController.ts', './SwitchNode.ts', './EdgeDetectionPass.ts', './EditorAsset.ts'], function () {
  return {
...
System.register("chunks:///_virtual/SwitchNode.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      var ccclass = _decorator.ccclass,
          property = _decorator.property;
      var SwitchNode = exports('SwitchNode', (_dec = ccclass('SwitchNode'), _dec2 = property([Node]), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        function SwitchNode() {
          ...
          _initializerDefineProperty(_this, "nodeList", _descriptor, _assertThisInitialized(_this));
        ...
        return SwitchNode;
      }(Component), _descriptor = _applyDecoratedDescriptor(_class2.prototype, "nodeList", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
